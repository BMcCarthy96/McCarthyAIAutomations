        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-zinc-500">
              Premium AI automation for businesses that want to scale without the chaos. Voice agents, chatbots, lead capture, custom integrations — with measurable outcomes in your client portal.
            </p>
            <Link
              href="/contact"
