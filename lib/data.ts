...
export const pricingTiers: PricingTier[] = [
  {
    ...
    price: "From $2,500",
    period: "per project",
    description: "One targeted automation that closes a specific revenue leak — shipped and handed off in weeks.",
    features: [
      "1 core AI system (chatbot, voice agent, or lead capture)",
  ...
  },
  {
    ...
    price: "From $5,500",
    period: "per project",
    description: "A connected automation stack — lead capture, follow-up, and reporting working together.",
    features: [
      "2–3 AI systems bundled",
      "Unlimited tool integrations",
      "90-day priority support",
      "Bi-weekly strategy check-ins",
      "Monthly performance reports",
      "Client portal access & impact dashboard",
    ],
    cta: "Book a discovery call",
    highlighted: true,
  },
  {
    ...
    description: "A dedicated AI partner for businesses ready to fully automate their growth stack.",
    features: [
      "Unlimited automations & expansions",
      "Dedicated account manager",
      "Weekly strategy sessions",
      "SLA guarantee & priority response",
